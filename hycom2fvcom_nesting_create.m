...
ftide = '../output/ECS_nesting_tide.mat';
dir_hycom = '../hycom';
fout = '../output/ECS_nesting.nc';
fout_tide = '../output/ECS_nesting_tide.nc';
fout_hycom = '../output/ECS_nesting_hycom.nc';
fout_lpf = '../output/ECS_nesting_lpf.nc';
time1 = datenum(2023, 12, 08, 0, 0, 0);
time2 = datenum(2024, 01, 01, 0, 0, 0);
dt_hycom = 3;
dt_out = 240; 
lpf_T_zeta = 33;
lpf_T_uv = 33;
...
if isempty(dir_hycom)
    hycom_zeta_lpf = zeta3 * 0;
    hycom_v_lpf = u3 * 0;
    hycom_u_lpf = v3 * 0;
    hycom_t = 25;
    hycom_s = 5;
